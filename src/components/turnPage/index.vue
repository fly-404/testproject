<!--
 * @Autor: fanmm
 * @Date: 2020-12-08 09:43:56
 * @LastEditors: fanmm
 * @LastEditTime: 2020-12-08 15:33:59
-->
<template>
  <div
    class="turn-wraper"
  ...
  >
    <div class="turn-page-left" :style="{ left: '-' + width + 'px' }">
      <div
        class="turn-page-left-clip"
        :style="
          Object.assign(
            {},
            { width: clipSize + 'px', height: clipSize + 'px' },
            styles[3]
          )
        "
      >
        <div
          class="turn-page-left-content"
          :style="
            Object.assign(
              {},
        ...
        >
          <div class="turn-page-left-inner">
            <div class="manual-item">
              ...
              <div class="manual-page">
                ...
                <!-- <div id="text" @click.self.stop="testClick" style="border:1px solid red">
                    测试
                </div> -->
                <slot></slot>
              </div>
          ...
          <div
            class="turn-page-left-gradient"
            :style="
              Object.assign(
                {},
                { top: '-' + height / 2 + 'px', height: height * 2 + 'px' },
                styles[4]
              )
            "
          ></div>
    ...
    <div
      ...
      :style="{ width: width + 'px', height: height + 'px', zIndex:$attrs.zdex? '10000': '' }"
    >
      <div
        class="turn-page-right-gradient"
        :style="
          Object.assign(
            {},
            { top: '-' + height / 2 + 'px', height: height * 2 + 'px' },
...
.page-photo::after {
  ...
  background-image: -webkit-gradient(
    ...
    right top,
    from(rgba(0, 0, 0, 0.2)),
    color-stop(6%, rgba(255, 255, 255, 0.15)),
